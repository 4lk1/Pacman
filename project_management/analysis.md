...
|---------------------------------|--------------------------------------------|------------------------------------------------------------------------|
| Graphical library               | pygame-ce ("MLX or similar")               | Every pygame function used (init, window, event loop, draw, blit, text) has an MLX equivalent; it is the standard simple 2D Python library. |
