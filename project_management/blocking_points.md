...
| 3 | Packaging for a public platform requires an account/credentials that a development environment cannot provide. | The packaging spec, build commands and butler deployment script are provided and tested as far as possible locally; the actual upload is a documented manual action for the owner's Itch.io account. |
